...
//    interface Strategy extends Serializable {
     ...
     */
    private final RedisBitArray bits;
     ...
     */
    private BloomFilter(
            RedisBitArray bits, int numHashFunctions, Funnel<? super T> funnel, Strategy strategy) {
...
//    }
    ...
    public static <T> BloomFilter<T> create(
            Funnel<? super T> funnel, int expectedInsertions, double fpp, String actKey, String statType) {
        return create(funnel, (long) expectedInsertions, fpp, actKey, statType);
    }
     ...
     */
    public static <T> BloomFilter<T> create(
            Funnel<? super T> funnel, long expectedInsertions, double fpp, String actKey, String statType) {
        return create(funnel, expectedInsertions, fpp, BloomFilterStrategies.MURMUR128_MITZ_64, actKey, statType);
    }

    @VisibleForTesting
    static <T> BloomFilter<T> create(
            Funnel<? super T> funnel, long expectedInsertions, double fpp, Strategy strategy, String actKey, String statType) {
        checkNotNull(funnel);
        checkArgument(
                expectedInsertions >= 0, "Expected insertions (%s) must be >= 0", expectedInsertions);
        checkArgument(fpp > 0.0, "False positive probability (%s) must be > 0.0", fpp);
     ...
     */
        ...
        try {
            return new BloomFilter<T>(new RedisBitArray(numBits, actKey, statType), numHashFunctions, funnel, strategy);
     ...
     * @return a {@code BloomFilter}
     */
    public static <T> BloomFilter<T> create(Funnel<? super T> funnel, int expectedInsertions, String actKey, String statType) {
        return create(funnel, (long) expectedInsertions, actKey, statType);
    }
     ...
     * @since 19.0
     */
    public static <T> BloomFilter<T> create(Funnel<? super T> funnel, long expectedInsertions, String actKey, String statType) {
        return create(funnel, expectedInsertions, 0.03, actKey, statType); // FYI, for 3%, we always get 5 hash functions
    }
...
//    }
    public static void main(String[] args) {
        long bitSize = optimalNumOfBits(10000000l, 0.0001);
